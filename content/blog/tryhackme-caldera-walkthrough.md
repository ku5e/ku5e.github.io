...
> **[IMAGE #7: Hero/Banner]** CALDERA web interface screenshot with post title overlay — _see Image Proposals.md_
...
> **[IMAGE #1: CALDERA Agent Deployment View]** Agents tab showing deployed Manx agent with status and group — _see Image Proposals.md_
...
> **[IMAGE #2: Adversary Profile — Emulation Activity #1]** Profile view showing all six abilities with tactic labels — _see Image Proposals.md_

Create the Emulation Activity #1 adversary profile, add all six abilities in tactic order, and run the operation.

> **[IMAGE #3: Operation Results View]** Operations tab showing ability pass/fail status after execution — _see Image Proposals.md_
...
> **[IMAGE #4: Sysmon Event ID 13 — Winlogon Registry Modification]** Event ID 13 log showing TargetObject and Details fields — _see Image Proposals.md_
...
> **[IMAGE #5: Aurora EDR Detection — Match Strings Field]** Aurora EDR log entry showing Sigma rule name and Match_Strings indicators — _see Image Proposals.md_
...
> **[IMAGE #6: Blue Dashboard — Incident Responder Profile]** Defender profile showing linked detection and response abilities — _see Image Proposals.md_
